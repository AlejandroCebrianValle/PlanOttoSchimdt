...
\begin{document}
    ...
    \input{./CitologiaHistologiaEmbriologia/secciones/ACV-CITO-Introduccion}
    \input{../CitologiaHistologia/README/secciones/ACV-CITO-Transporte}
    \part{Embriología}
    \part{Fisiología}
    \part{Genética y Biología Molecular}
    \part{Microbiología}
    % SEC I - Introducción
    \input{../Microbiologia/README/secciones/ACV-MICROBIO-Tema1-Introduccion}
    % SEC X - Citoplasma
    \input{../Microbiologia/README/secciones/ACV-MICROBIO-TemaX-Citoplasma}
    \part{Parasitología}
    % SEC I - Introducción
    \input{../Parasitologia/A.README/secciones/ACV-PARASIT-Tema1-Introduccion}
    % SEC I - Protozoos
    \input{../Parasitologia/A.README/secciones/ACV-PARASIT-Tema2-Protozoa}
    % SEC III - Platelmintos
    \input{../Parasitologia/A.README/secciones/ACV-PARASIT-Tema3-Plathelmintes}
    % SEC IV - Nemátodos
    \input{../Parasitologia/A.README/secciones/ACV-PARASIT-Tema4-Nemathelmintes}
    % SEC V - Artropodos
    \input{../Parasitologia/A.README/secciones/ACV-PARASIT-Tema5-Arthropoda}
    \part{Zoología}
    \input{../Zoologia/A.README/secciones/ACV-ANATANIM-Introduccion}
    \part{Metodologías de laboratorio}
    \input{secciones/ACV-ADENDA-MetodologiasLaboratorio}
    \part{Epidemiología}
    % SEC I - Introducción
    \input{../Epidemiologia/README/secciones/ACV-EPI-Intro}
    % SEC II - Tipos de estudio
    \input{../Epidemiologia/README/secciones/ACV-EPI-TiposEstudio}
    % SEC III - Medidas Frecuencia
    \input{../Epidemiologia/README/secciones/ACV-EPI-MedidasFrecuencia}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %APPENDICES
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \part{Adendas}
