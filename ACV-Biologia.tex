...
\usepackage[left=1.19cm, right=1.19cm, top=1.4cm, bottom=1.4cm, bindingoffset=1.2cm, head=15pt]{geometry} 
\usepackage{setspace}
    \onehalfspacing
% set headers
\usepackage{fancyhdr}
...
\begin{document}
    ...
    \part{Metodologías de laboratorio}
     \input{A.secciones/ACV-ADENDA-MetodologiasLaboratorio}
    \part{Epidemiología}
    % SEC I - Introducción
    ...
    % SEC Adenda Temario Ayudante Investigacion
     \input{A.secciones/ACV-Adenda-ExposicionRiesgosBiologicos}
    \clearpage
     \input{A.secciones/ACV-Adenda-SistemaMedidas}
    \clearpage
     \input{A.secciones/ACV-Adenda-Calibracion}
    \clearpage
