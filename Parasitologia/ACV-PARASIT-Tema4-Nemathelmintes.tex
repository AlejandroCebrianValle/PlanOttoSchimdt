...
\begin{figure}[H]
	\centering
	\subfigure[Morfología de \textit{A. duodenale}]{\includegraphics[width=0.475\columnwidth]{figuras/ACV-BioSan-ParasitAduodenaleMorf}}
	\subfigure[Diferencias morfológicas entre \textit{A. duodenale} y \textit{N. americanus}]{\includegraphics[width=0.475\columnwidth]{figuras/ACV-BioSan-ParasitAduodenaleNamericanusMorf}}
